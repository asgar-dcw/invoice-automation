        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-2.5 px-7 py-3 font-bold text-sm rounded-xl transition-all duration-300 disabled:cursor-not-allowed overflow-hidden
            ...
            >
              ...
              <span className="relative z-10">Run Invoice Automation</span>
            </button>
          </div>
        </div>
      </div>
